...
@implementation BFSISSubscriptionKey
...
static SUPClassMetaDataRBS* BFSISSubscriptionKey_META_DATA;

+ (SUPClassMetaDataRBS*)metaData
{
    if (BFSISSubscriptionKey_META_DATA == nil) {
 	   	BFSISSubscriptionKey_META_DATA = [[BFSISSubscriptionKeyMetaData alloc] init];
	}
	
	return BFSISSubscriptionKey_META_DATA;
}
...
static SUPClassDelegate *g_BFSISSubscriptionKey_delegate = nil;

+ (SUPClassDelegate *) delegate
{
	@synchronized(self) {
		if (g_BFSISSubscriptionKey_delegate == nil) {
			g_BFSISSubscriptionKey_delegate = [[SUPClassDelegate alloc] initWithName:@"BFSISSubscriptionKey" clazz:[self class]
				metaData:[self metaData] dbDelegate:[BFSMP_TesterDB delegate] database:[BFSMP_TesterDB instance]];
		}
	}
	
	return [[g_BFSISSubscriptionKey_delegate retain] autorelease];
}
