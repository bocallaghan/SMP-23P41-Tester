...
@implementation BFLocalKeyGeneratorMetaData

+ (BFLocalKeyGeneratorMetaData*)getInstance
{
    return [[[BFLocalKeyGeneratorMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		...
		self.klass = [BFLocalKeyGenerator class];
		...
		self.table = @"co_smp_tester_1_0_localkeygenerator";
