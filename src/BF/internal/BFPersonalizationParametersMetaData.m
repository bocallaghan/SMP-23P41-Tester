...
@implementation BFPersonalizationParametersMetaData

+ (BFPersonalizationParametersMetaData*)getInstance
{
    return [[[BFPersonalizationParametersMetaData alloc] init] autorelease];
}
...
- (id)init
{
	if (self = [super init]) {
		...
		self.klass = [BFPersonalizationParameters class];
