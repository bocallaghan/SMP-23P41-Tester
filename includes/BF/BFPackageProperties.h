...
@interface BFPackageProperties : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData, SUPAbstractPackageProperties>
{
@private
    NSString* _value;
    NSString* _key;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (BFPackageProperties*)load:(NSString*)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of BFPackageProperties objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList BFPackagePropertiesList;